...
HF_VIDEO_MODEL = os.getenv("HF_VIDEO_MODEL", "Lightricks/LTX-Video")
...
def api_video_generate():
    ...
    try:
        # Hugging Face routing -> fal-ai, using LTX-Video.
        # The generated result is returned as raw video bytes by the SDK.
