...
HF_VIDEO_MODEL = os.getenv("HF_VIDEO_MODEL", "Lightricks/LTX-Video-0.9.8-13B-distilled")
...
def api_video_generate():
    ...
    try:
        # Use the Hugging Face text-to-video model supported by
        # the Inference Providers routing.
        # Override the old model name if it is still set in Render.
        video_model = HF_VIDEO_MODEL
        if video_model == "Lightricks/LTX-Video":
